  ...
  map λ where
    (m , e) →
      ...
      , (fun-ext λ κ →
          ...
          δᵏ ((if ⌜ n ≤ᵇ 89 ⌝ then δᵏ (f91ᵏ (22 + n) >>=ᵏ f91ᵏ) else now (suc n)) >>=ᵏ f91ᵏ)
...
f91＝91-100-n≤10 (suc n) n≤10 =
  f91-suc-90≤n≤100 (99 ∸ n) 91
    (subst (90 ≤_) (m+[n∸p]＝m+n∸p 90 9 n (≤-peel n≤10)) (true-reflects (≤-reflects 90 (90 + (9 ∸ n))) refl))
    (≤-∸-l-≃ {p = n} .fst z≤) $
...
f91＝91-·11 (suc k) n k11<100 n≥90-k11 n≤100-k11 =
  ...
  (f91＝91-·11 k (11 + n)
              (<-trans <-+-lr k11<100)
              (≤-∸-l-≃ {m = 90} {p = k · 11} .fst (≤-∸-l-≃ .fst n≥90-k11))
              (subst (11 + n ≤_) (m+[n∸p]＝m+n∸p 11 89 (k · 11) (<→≤ (<-+≃2l .fst k11<100)))
                     ((≤-+≃2l ₑ⁻¹) .fst n≤100-k11)))
